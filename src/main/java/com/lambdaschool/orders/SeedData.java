...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Orders o01 = new Orders(1000.00, 600.00, c13, a03, "SOD", newCustomer);
        Orders o02 = new Orders(3000.00, 500.00, c19, a10, "SOD", newCustomer);
        Orders o03 = new Orders(4500.00, 900.00, c07, a10, "SOD", newCustomer);
        Orders o04 = new Orders(2000.00, 400.00, c16, a07, "SOD", newCustomer);
        Orders o05 = new Orders(4000.00, 600.00, c22, a02, "SOD", newCustomer);
        Orders o06 = new Orders(2000.00, 300.00, c12, a12, "SOD", newCustomer);
        Orders o07 = new Orders(3500.00, 2000.00, c02, a08, "SOD", newCustomer);
        Orders o08 = new Orders(2500.00, 400.00, c03, a04, "SOD", newCustomer);
        Orders o09 = new Orders(500.00, 100.00, c23, a06, "SOD", newCustomer);
        Orders o10 = new Orders(4000.00, 700.00, c07, a10, "SOD", newCustomer);
        Orders o11 = new Orders(1500.00, 600.00, c08, a04, "SOD", newCustomer);
        Orders o12 = new Orders(2500.00, 400.00, c25, a11, "SOD", newCustomer);
